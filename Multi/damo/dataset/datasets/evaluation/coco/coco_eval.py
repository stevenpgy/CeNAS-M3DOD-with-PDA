...
def evaluate_box_proposals(predictions,
    ...
    if thresholds is None:
        step = 0.05
        thresholds = torch.arange(0.7, 0.95 + 1e-5, step, dtype=torch.float32)
...
class COCOResults(object):
    METRICS = {
        'bbox': ['AP', 'AP50', 'AP75'], #['AP', 'AP50', 'AP75', 'APs', 'APm', 'APl'],
        'segm': ['AP', 'AP50', 'AP75'], #['AP', 'AP50', 'AP75', 'APs', 'APm', 'APl'],
        'box_proposal': [
            'AR@40',
            """
            'ARs@100',
